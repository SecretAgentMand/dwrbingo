...
var goals = [
  ...
  {"name": "Buy radishes with Gwaelin in Cantlin"},
  {"name": "Take Gwaelin to dying soldier in Brecconary"},
  {"name": "Take Gwaelin to the Puff Puff woman in Kol"},
  {"name": "Take Gwaelin to 'I hate people' woman in Garinham"},
  {"name": "Take Gwaelin to jealous soldier in Tantagel"},
  {"name": "Take Gwaelin to separated couple in Rim"}],
  ...
  {"name": "Kill a Magidrakee with Copper/Flame/Erdrick's Sword"},
  {"name": "Attempt to light up a Wraith with the Stones of Sunlight"},
  {"name": "Kill a Wolf with a shield equipped"},
  {"name": "Kill a Warlock with Leather/Magic/Erdrick's Armor"}],
